...
const CreateListing = () => {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true)
    const imgUrls = await uploadImages(images, storage)
  ...
  return (
    <main className='py-4'>
      <div className="container">
        <h2 className="display-3 fw-bold mb-4">Create Listing</h2>
        <form onSubmit={handleSubmit} className='vstack gap-3'>
          ...
          <div>
            ...
            <p className="mb-2">The first image will be the cover (max 6)</p>
            <input type="file" multiple name="images" id="images" className='form-control' onChange={handleImageChange} />
          </div>
